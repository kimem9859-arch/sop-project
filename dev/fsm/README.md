...
> [`docs/통합문서.md`](../../docs/통합문서.md) §7.

## 현황 (Rpi5/Demo/fsm.py) — 2026-07-18 현행화
- 6상태: IDLE / READY / PROCESS_RUN / MONITOR / WARNING / BLOCK.
- **오답 ROI → 타이머 → WARNING/BLOCK**(단계적) / **EMO → 즉시 BLOCK**(해제 시 「작업 시작」 전 대기 IDLE · 기대단계 1). ※구판의 "오답 → 즉시 BLOCK" 서술은 오기 — 즉시 BLOCK은 EMO뿐(정본 §9·Rpi5/CLAUDE.md).
...
- 추론 백엔드: **`console_v2.hef` 배포·`config.HEF_MODEL_PATH` v2 전환됨**(2026-07-16, B4 판정은 §12.16). ※구판의 "FakeDetector 사용"은 2026-06-11 console_v1 통합으로 해소된 옛 기록.
